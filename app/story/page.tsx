      ...
      <section className="bg-bost-cream px-6 py-24 md:px-12 md:py-32 lg:px-24">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
            ...
            <p className="max-w-sm text-bost-olive/60 text-base leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {principles.map((principle, i) => (
              ...
              >
                ...
                <p className="text-bost-olive/60 text-base leading-relaxed transition-colors group-hover:text-white/80">
